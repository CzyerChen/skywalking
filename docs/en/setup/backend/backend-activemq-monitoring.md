...
| GC Young Collection Time                   | ms         | meter_activemq_cluster_gc_young_collection_time                         | The gc time spent in G1 Young Generation in milliseconds.                             | JMX Prometheus Exporter |
| Enqueue Rate                               | Count/s    | meter_activemq_cluster_enqueue_rate                                     | Number of messages that have been sent to the cluster per second.                     | JMX Prometheus Exporter |
