...
| GC Old Collection Count                    | Count      | meter_activemq_cluster_gc_old_collection_count                          | The gc count of G1 Old Generation.                                                    | JMX Prometheus Exporter |
| GC Young Collection Count                  | Count      | meter_activemq_cluster_gc_young_collection_count                        | The gc count of G1 Young Generation.                                                  | JMX Prometheus Exporter |
| GC Old Collection Time                     | ms         | meter_activemq_cluster_gc_old_collection_time                           | The gc time spent in G1 Old Generation in milliseconds.                               | JMX Prometheus Exporter |
| GC Young Collection Time                   | ms         | meter_activemq_cluster_gc_young_collection_time                         | The gc time spent in Young Old Generation in milliseconds.                            | JMX Prometheus Exporter |
| Enqueue Rate                               | Count/s    | meter_activemq_cluster_enqueue_rate                                     | Number of messages that have been sent to the broker per second.                      | JMX Prometheus Exporter |
| Dequeue Rate                               | Count/s    | meter_activemq_cluster_dequeue_rate                                     | Number of messages that have been acknowledged or discarded on the broker per second. | JMX Prometheus Exporter |
